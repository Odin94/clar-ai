...
const envSchema = z.object({
    ...
    BACKEND_VALID_API_KEY: z.string().optional(),
...
export const env = parsed.success
    ...
    : {
          ...
          BACKEND_VALID_API_KEY: process.env["BACKEND_VALID_API_KEY"],
...
if (!env.ELEVENLABS_AGENT_ID) {
    console.warn("Warning: ELEVENLABS_AGENT_ID is not set. Sync will not work.")
}
if (!env.BACKEND_VALID_API_KEY) {
    console.warn("Warning: BACKEND_VALID_API_KEY is not set. API endpoints will not work.")
}
